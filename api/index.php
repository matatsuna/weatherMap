...
$results=$mysqli->query("select area_table.prefecture_name,sum(rainfall_level) from weather_table,area_table where weather_table.prefecture_id=area_table.prefecture_id and month=".$month." and year=2008 group by weather_table.prefecture_id");
$json = array();
$jsonchild = array();
